...
custos_release = {
    ...
    'Lucro Empresa': 3571.43,  # 50% do custo de mão de obra
    'Custos Fixos': 1428.57,    # 20% do custo de mão de obra
    'Valor da Release': 12142.86
}
...
if aba_selecionada == 'Release':
    ...
    if 'Junior' in dados.columns and 'Pleno' in dados.columns and 'Senior' in dados.columns:
        ...
        custo_pleno = total_pleno * 178.57    # Valor exemplo por hora
        custo_senior = total_senior * 238.10   # Valor exemplo por hora
